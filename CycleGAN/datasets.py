...
class ImageDataset(Dataset):
    def __init__(self, root, transform=None, model="train"):
        ...
        self.files_A = os.path.join(root, model, "trainA/*")
        self.files_B = os.path.join(root, model, "trainB/*")
...
if __name__ == "__main__":
    ...
    root = "data"
    transform = [transforms.Resize(256, Image.BILINEAR), transforms.ToTensor()]
